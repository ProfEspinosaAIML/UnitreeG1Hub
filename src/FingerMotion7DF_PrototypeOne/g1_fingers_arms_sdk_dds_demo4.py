...
LEFT_CUBE_PRESENTATION = [

    0.0,   1.20, 0.0, 0.80, 0.0, 0.0, 0.0,
...
LEFT_CUBE_DISPLAY = [
    ...
    -3.00,    # LeftWristRoll (aggressive palm-up attempt)
    0.0,      # LeftWristPitch
    0.75,     # LeftWristYaw
...
input("\nRobot READY. Press ENTER to start Demo 4...")

print()
print("=" * 60)
print("G1 FINGERS + ARMS DEMO 4")
print("=" * 60)
...
print("\nSTAGE 3 : MIRROR MOTION")

left_hand_pose(finger_a_base=-1.0, finger_a_tip=-1.0)
right_hand_pose(finger_a=1.0)
hold(2)

left_hand_pose(finger_b_base=-1.0, finger_b_tip=-1.0)
right_hand_pose(finger_b=1.0)
hold(2)
...
print("\nSTAGE 5 : DUAL THUMB SHOWCASE")

left_hand_pose(thumb=-1.0)
right_hand_pose(thumb=1.0)
hold(2)
...
print("STAGE 10 : OBJECT MANIPULATION DEMONSTRATION")

print("Place foam cube in left hand...")
...
# Step 1: neutralize wrist while shoulder/elbow remain fixed
move_arm_pose(
    [
        0.00, 1.20, 0.00, 0.80,
        -1.50, 0.00, 0.35,
...
for _ in range(100):
    ...
    left_hand_pub.Write(build_hand_cmd(left_hand_q))
    right_hand_pub.Write(build_hand_cmd(right_hand_q))
